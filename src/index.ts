...
const BOT_FILE = path.join(__dirname, (process.env.botFilePath || '../bot.bot'));
...
const adapter = new BotFrameworkAdapter({
    appId: endpointConfig.appId || process.env.botAppId,
    appPassword: endpointConfig.appPassword || process.env.botAppPassword
});
